...
6 T=40:GSB90:CLS:FORI=0TO21:LC9,I:?"Ə":LC20,I:?"Ə":NEXT:COPY#BAA,#BA9,10
7 X=14:Y=0:V=[R]:IFSCR(15,2)ENDELSER=(R+1)%7:IF!RGSB90
8 LC6,23:J=[R]:I=[36+J]:?"NEXT:";CHR$(I);CHR$(I>>8),"SCORE:";N;
9 C=248:GSB80
10 A=0:S=0:IF!IN(1)||TICK()>T+3CLT:B=1:ELSEB=0:A=IN(4)-IN(3):S=BTN():IFA|S^U=0WAIT2:CONT
11 U=S:C=0:GSB80:I=W:X=X+A:Y=Y+B:W=(W+S)%4:C=-1:GSB80:IF!ZGOTO9
12 X=X-A:Y=Y-B:W=I:IF!BGOTO9
13 C=2:GSB80:FORJ=YTOY+3:L=0:FORI=10TO19:L=L+!!SCR(I,J):NEXT:M=L=10:COPY#91F+J*32,#91F+(J-M)*32,-J*32:U=U+M:NEXT:N=N+10*U*U+1:T=T-2*(T*U>0):GOTO7
80 Z=USR(#700,C):RTN
90 I=7
