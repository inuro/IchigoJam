...
6 T=60:U=0:A=0:GSB99:CLS:FORI=0TO21:LC9,I:?"Ə":LC20,I:?"Ə":NEXT:COPY#BAA,#BA9,10
...
11 U=S:W=0:GSB89:I=R:X=X+H:Y=Y+V:R=(R+S)%4:W=-1:GSB89:IF!ZGOTO9
12 X=X-H:Y=Y-V:R=I:IF!VGOTO9
13 W=2:GSB89:FORJ=YTOY+3:L=0:FORI=10TO19:L=L+(SCR(I,J)>0):NEXT:COPY#91F+J*32,#91F+(J-(L=10))*32,-J*32:NEXT:GOTO7
89 Z=USR(#848,W):RTN
