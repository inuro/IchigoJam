...
200 T=60:CLS:FORI=0TO21:LC9,I:?"          ":NEXT:COPY#BAA,#BA9,10
210 @A:X=14:Y=0:B=RND(7):R=0:U=1:CLT
220 @B:IFTICK()>T CLT:V=1:GOTO@C
230 H=BTN(29)-BTN(28):V=BTN(31):S=BTN(32)
240 @C:IF H|V|S^U W=-1:GSB@D
250 IF Z=0 W=0:GSB@D:R=(R+S)%4:X=X+H:Y=Y+V:W=248:GSB@D:U=S:GOTO@B
ELSE IF V W=255:GSB@D:U=S:GOTO@A
ELSE GOTO@B
