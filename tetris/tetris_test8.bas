...
220 @B:W=248:GSB@Z
230 IFTICK()>TCLT:V=1ELSEH=BTN(29)-BTN(28):V=BTN(31):S=BTN(32):IFH|V|S^U=0CONT
240 U=S:W=0:GSB@Z:X=X+H:Y=Y+V:R=(R+S)%4:W=-1:GSB@Z:IF!ZGOTO@B
250 X=X-H:Y=Y-V:R=(R-S)%4:IF!VGOTO@B
260 W=2:GSB@Z:LC0,23:?Y;:FORJ=Y-1TOY+2:L=0:FORI=10TO19:L=L+(SCR(I,J)>0):NEXT:COPY#91F+J*32,#91F+(J-(L=10))*32,-I*32:?L,",";:NEXT:GOTO@A
