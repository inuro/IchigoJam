...
30 IF INKEY()=0 CONT ELSE N=0:S=0:CLS:CLT
50 Z=TICK():LC 16,10:?(180-Z)/60+1:IF Z<180 CONT ELSE CLS
60 @Q:A=RND(100):B=RND(100):I=-1:R=-1:Y=D-100:CLT
...
105 IF T<Y PLAY"O5B32":IF Y<200 Y=Y-25 ELSE IF Y<600 Y=Y-50 ELSE Y=Y-100
110 IF K<48 || K>57 GOTO @KEY
120 IF I<2 I=I+1:[I]=K-48:LC10+I,N:?[I]
130 GOTO @KEY
140 @CHK:R=0:M=1:FOR J=0 TO I
150 R=R+[I-J]*M:M=M*10:NEXT
160 @SCR:LC18,N:IF R=A+B S=S+T:?"V":PLAY"O4E24C24E24C12" ELSE ?"* 0pts   ":PLAY"O3D24R24D8"
...
220 IF INKEY()=0 CONT ELSE GOTO @TTL
